...
# --model pose.caffemodel --proto pose.prototxt --dataset MPI
import cv2 as cv
import numpy as np
import argparse
...
parser.add_argument('--proto', default='pose/coco/pose_deploy_linevec.prototxt', type=str, help='Path to .prototxt')
parser.add_argument('--model', default='pose/coco/pose_iter_440000.caffemodel', type=str, help='Path to .caffemodel')
parser.add_argument('--dataset', default='COCO', type=str, help='Specify what kind of model was trained. '
...
if args.dataset == 'COCO':
    ...
    args.proto='pose/coco/pose_deploy_linevec.prototxt' #'pose/mpi/pose_deploy_linevec_faster_4_stages.prototxt'
    ...
    args.proto = 'pose/hand/pose_deploy.prototxt'
    args.model = 'pose/hand/pose_iter_102000.caffemodel'
